/**
 * Manejador de respuestas para la función updateBook
 */
class UpdateBookResponseHandler {
    /**
     * Respuesta exitosa
    ...
    static methodNotAllowed() {
        return this.error(405, 'Method Not Allowed', 'Only PUT method is allowed');
    }
     ...
     * @returns {Object} - Respuesta HTTP
     */
    static internalServerError(message = 'An error occurred while updating the book') {
        return this.error(500, 'Internal Server Error', message);
    }
}

module.exports = UpdateBookResponseHandler;
