/**
 * Manejador de respuestas para la función deleteBook
 */
class DeleteBookResponseHandler {
    /**
     * Respuesta exitosa
    ...
    static methodNotAllowed() {
        return this.error(405, 'Method Not Allowed', 'Only DELETE method is allowed');
    }
     ...
     * @returns {Object} - Respuesta HTTP
     */
    static internalServerError(message = 'An error occurred while deleting the book') {
        return this.error(500, 'Internal Server Error', message);
    }
}

module.exports = DeleteBookResponseHandler;
